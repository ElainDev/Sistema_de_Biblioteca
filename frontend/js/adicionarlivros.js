...
const cardsRegistro = document.querySelector(".cards-registro");
...
const botaoRegistrar = document.getElementById("botao-registrar-livro");
  ...
  document.querySelectorAll(".btn-ler-mais").forEach((btn) => {
    btn.addEventListener("click", (e) => {
      ...
      modalDetalhes.querySelector("#modalExemplares").innerText =
        livro.exemplares;
      modalDetalhes.querySelector("#modal-sinopse").innerText = livro.sinopse;
...
inputCapa.addEventListener("change", function () {
  ...
  if (file) {
    ...
    reader.onload = function (e) {
      ...
      console.log(
        "📷 Imagem selecionada:",
        imagemSelecionada.substring(0, 50) + "...",
      );
    };
