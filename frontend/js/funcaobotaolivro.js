const button = document.querySelector("#botao-registrar-livro");
const modal = document.querySelector(".modal-livro");
const fechar = document.querySelector(".fechar-modal");

const form = document.querySelector(".form-livro");

const cards = document.querySelector(".cards-registro");
...
const fecharDetalhes = modalDetalhes.querySelector(".fechar-modal");
